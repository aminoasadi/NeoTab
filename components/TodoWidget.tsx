...
export function TodoWidget() {
  const [tasks, setTasks] = useState([
    { id: 1, text: 'پیگیری خسارت آقای رضایی', completed: false, priority: 'high', due: 'امروز' },
    { id: 2, text: 'ارسال پیش‌فاکتور شرکت آلفا', completed: false, priority: 'medium', due: 'فردا' },
    { id: 3, text: 'بررسی کارمزد ماه گذشته', completed: true, priority: 'low', due: 'دیروز' },
  ]);
